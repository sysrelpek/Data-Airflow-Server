# Production Setup – Deploy(Post-Sync) ToDo Checklist
...
## Deploy(Post-Sync) Checklist (must do) or See next section Deploy(Post-Sync) all at once
...
## Deploy(Post-Sync) all at once

# 1. Go to project root on the server
cd /home/etluser/ai-projects/data_airflow_server

# 2. Make the deploy at once script executable
chmod +x scripts/prod/setup/deploy.sh
